...
• Время отправки: ${new Date().toLocaleString('ru-RU')}
  ...
  return (
    <div className="flex lg:flex-row sm:flex-col justify-between items-center w-[85%] sm:w-full flex-1">
      <div className="flex rounded-[16px] shadow-[0_4px_30px_rgba(0,0,0,0.1)] border border-[rgba(255,255,255,0.51)] w-[40%] md:w-full sm:w-full sm:h-1/2 h-[28em] p-[2em]">
        <form onSubmit={handleSubmit} className="flex flex-col w-full space-y-4">
          ...
          <button type="submit" disabled={isSubmitting} className={`w-full p-2 bg-black text-white rounded ${errors.name || errors.phone ? 'bg-red' : 'bg-black' }`}>
