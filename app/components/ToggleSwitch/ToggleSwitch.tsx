...
const ToggleSwitch = () => {
  ...
  return (
    <div 
      ...
      onClick={toggleTheme}
    >
      <input id="checkbox-input" type="checkbox" checked={theme === 'dark'} readOnly className="hidden" />

      <div
        className={`w-10 h-10 flex items-center justify-center rounded-full transition-all duration-500
          ${theme === 'dark' ? 'bg-amber-500/40 shadow-[0px_0px_20px_rgb(255,196,0)]' : 'bg-gray/20'}
        `}
      >
        <svg
          viewBox="0 0 128 128"
