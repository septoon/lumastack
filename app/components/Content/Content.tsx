  ...
  return (
    <div className="flex items-center justify-center w-full h-auto">
        <div className={`flex flex-col items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center animate-float`}>
          ...
          dark:from-gradientDark1 dark:via-gradientDark2 dark:to-gradientDark3 
          max-w-[555px] sm:text-5xl md:text-6xl">
          ...
          mt-5 max-w-sm mx-auto rounded-2xl bg-btn-light dark:bg-btn-dark shadow-lg cursor-pointer sm:flex sm:justify-center md:mt-8 transition-all duration-300 hover:scale-105">
